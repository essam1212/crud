            ...
            <div className=''>
                ...
                <form className=' py-4  text-center border border-warning border-5 rounded-5 bg-secondary mb-3 mt-3 w-100' onSubmit={addProduct}>
                    <div className="row justify-content-center align-items-center">
                        <div class=" mb-3 col-lg-2 col-md-4 col-sm-6 ">
                    ...
                    <button id='myBtn' type='submit' className=' col-3 btn btn-outline-info fs- fw-bold rounded-5 '>OK <i class="fa-solid fa-paper-plane"></i></button>
                ...
                <table className="table  table-dark  text-center">
                    <thead>
                        <tr className=''>
                            ...
                            <th className="bg-transparent" scope="col"></th>
                            <th className='border border-dark bg-success pe-4' >Count :</th>
                            <th className='border border-dark bg-success pe-4' >{calcCount()}</th>
                            <th className="border border-dark bg-success pe-4" >Total befor :</th>
                            <th className="border border-dark bg-success pe-4" >{calcTotal2()} EGP</th>
                            <th className="bg-transparent" ></th>
                            <th className='border border-dark bg-success pe-4' >Total After :</th>
                            <th className='border border-dark bg-success pe-4' >{calcTotal()} EGP</th>
                            <th className="bg-transparent" ></th>
                            <th className="bg-transparent" ></th>
                            {localStorage.length ? <th className='border border-secondary pe-4 ' scope="col">
                        ...
                        <tr className='border border-primary '>
                            <th className='border border-dark bg-secondary pe-4 ' scope="col">N</th>
                            <th className='border border-dark bg-secondary pe-4' scope="col">Name</th>
                            <th className='border border-dark bg-secondary pe-4' scope="col">Type</th>
                            <th className='border border-dark bg-secondary pe-4' scope="col">Count</th>
                            <th className='border border-dark bg-secondary pe-4' scope="col">Discount</th>
                            <th className='border border-dark bg-secondary pe-4' scope="col">Price</th>
                            <th className='border border-dark bg-secondary pe-4' scope="col">Add</th>
                            <th className='border border-dark bg-secondary pe-4' scope="col">Dis EGP</th>
                            <th className='border border-dark bg-secondary pe-4' scope="col">Total</th>
                            <th className='border border-dark bg-secondary pe-4' scope="col">Notes</th>
                            <th className='border border-dark bg-secondary pe-4' scope="col">Update <i class="fa-solid fa-pen-to-square text-warning"></i></th>
                            <th className='border border-dark bg-secondary pe-4' scope="col">Delete <i class="fa-solid fa-trash-can text-danger "></i></th>
                        </tr>
                    </thead>
                    <tbody>
