                ...
                <tbody>
                    {
                        ...
                        //                 <tr>
                        //                     <th className='border border-secondary' scope="row">{index + 1}</th>
                        //                     <td className='border border-secondary text-capitalize' >{el.name}</td>
                        //                     <td className='border border-secondary text-capitalize'></td>
                        //                     <td className='border border-secondary'>{el.count}</td>
                        //                     <td className='border border-secondary'>%</td>
                        //                     <td className='border border-secondary'> EGP</td>
                        //                     <td className='border border-secondary text-capitalize'> EGP</td>
                        //                     <td className='border border-secondary text-capitalize'> EGP</td>
                        //                     <td className='border border-secondary'> EGP</td>
                        //                     <td className='border border-secondary text-capitalize'></td>
                        //                     <td className='border border-secondary'><button className=" btn btn-outline-warning w-100" > Uptade <i class="fa-solid fa-pen-to-square"></i></button> </td>
